...
2. User can specify the root cluster and leaf clusters to build a spanning tree.
   ...
   Here, cluster 5 and 7 are derived from cluster 3. Hence, they are parallel. 
   cluster 8 and 9 are derived from cluster 11. Hence, they are parallel.
   cluster 12 and 16 are linear connected,  Hence, they are linear.
   cluster 10 and 4 are separated clusters.
